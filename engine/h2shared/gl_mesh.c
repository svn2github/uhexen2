...
void GL_MakeAliasModelDisplayLists (qmodel_t *m, aliashdr_t *hdr)
{
	...
	hscale = (float)(hdr->gltextures[0][0]->source_width) / (float)TexMgr_PadConditional(hdr->gltextures[0][0]->width);
	vscale = (float)(hdr->gltextures[0][0]->source_height) / (float)TexMgr_PadConditional(hdr->gltextures[0][0]->height);
